...
const ProgressBar = ({ currentStep, totalSteps, steps, onStepClick }: ProgressBarProps) => {
  ...
  return (
    <div className="w-full mb-4 px-2 sm:mb-8 sm:px-0" role="navigation" aria-label="Progress">
      <div className="mb-2 flex justify-center sm:mb-4">
        <div className="w-full max-w-2xl mt-4">
          ...
          {steps.map((stepKey, index) => {
            ...
            return (
              <li key={stepKey} className={`flex items-center ${index < steps.length - 1 ? 'flex-1' : ''} ${
                ...
                <div className="flex flex-col items-center relative">
                  <button
                    ...
                    className={`flex items-center justify-center w-8 h-8 rounded-full shrink-0 transition-all duration-200 touch-manipulation sm:w-10 sm:h-10 ${
                ...
                {index < steps.length - 1 && (
                  <div className="flex-1 flex items-center justify-center mx-1 sm:mx-4">
                    <div className={`h-px w-full sm:h-0.5 ${
      ...
      <div className="text-xs text-gray-600 text-center font-medium sm:text-sm" aria-live="polite">
