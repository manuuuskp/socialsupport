...
const Layout = () => {
    const [currentPage, setCurrentPage] = useState<'form' | 'success'>('form');
    const [applicationId, setApplicationId] = useState<string>('');

    const handleFormSubmissionSuccess = (appId: string) => {
            ...
            <main className="flex-1 pt-16 overflow-y-auto mobile-scroll">
                {currentPage === 'form' ? (
                    <Suspense fallback={
                        ...
                        <SocialSupportForm onSubmissionSuccess={handleFormSubmissionSuccess} />
                    </Suspense>
                ) : (
                    <SuccessPage 
